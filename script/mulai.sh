...
[Install]
WantedBy=multi-user.target#!/bin/bash#!/bin/bash
# Script Remake By WILDY VPN
# Source = Horass & Kangarid & Mbak Google & Pak Google
# ISS JADI SAYANG KU CIUM LU NANT LOHHH
# ======================================================
...
wget https://github.com/joenurul/wildyvpn.github.io/blob/main/script/ipsec.sh && chmod +x ipsec.sh && ./ipsec.sh
wget https://github.com/joenurul/wildyvpn.github.io/blob/main/script/v2ray.sh && chmod +x v2ray.sh && ./v2ray.sh
...
# Banner WILDYVPN
wget -O /etc/issue.net "https://github.com/joenurul/wildyvpn.github.io/blob/main/script/banner.conf"
